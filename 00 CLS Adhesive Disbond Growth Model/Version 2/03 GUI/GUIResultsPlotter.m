function varargout = GUIResultsPlotter(varargin)
% GUIRESULTSPLOTTER MATLAB code for GUIResultsPlotter.fig
%      GUIRESULTSPLOTTER, by itself, creates a new GUIRESULTSPLOTTER or raises the existing
%      singleton*.
%
%      H = GUIRESULTSPLOTTER returns the handle to a new GUIRESULTSPLOTTER or the handle to
%      the existing singleton*.
%
%      GUIRESULTSPLOTTER('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUIRESULTSPLOTTER.M with the given input arguments.
%
%      GUIRESULTSPLOTTER('Property','Value',...) creates a new GUIRESULTSPLOTTER or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GUIResultsPlotter_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUIResultsPlotter_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GUIResultsPlotter

% Last Modified by GUIDE v2.5 14-Oct-2018 10:22:33

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GUIResultsPlotter_OpeningFcn, ...
                   'gui_OutputFcn',  @GUIResultsPlotter_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GUIResultsPlotter is made visible.
function GUIResultsPlotter_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GUIResultsPlotter (see VARARGIN)

% Choose default command line output for GUIResultsPlotter
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes GUIResultsPlotter wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GUIResultsPlotter_OutputFcn(hObject, eventdata, handles) 
