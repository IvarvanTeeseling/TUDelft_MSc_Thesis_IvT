function [Shr_a, Pl_a, ad1, ad2] = Calc_OverlapStressesAndLoads(x, F_k, M_k, Q_k, D_1, A_11, l_B, E, t, E_a, G_a, t_a)
%% Description
% Synt_ax
%   >Calc_OverlapStressesAndLoads(x, F, D_1, A_11, D_0, l_A, l_B, E, t, E_a, G_a, t_a)
% Input
...
% Note: only numerical integration as it is a lot quicker than the exact
