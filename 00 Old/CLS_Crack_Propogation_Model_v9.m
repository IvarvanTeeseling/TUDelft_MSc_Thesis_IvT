...
% MR of 5 assumed from FEM data from Lai et al. (KII/KI)
G_I1 = G_T1/6;
G_II1 = G_I1*5;
...
figure(r+1)
hold on
plot((x0(1,1:qmax)),G_I(:,:,2),'r') % This solution
plot((x0(1,1:qmax)),G_II(:,:,2),'b')
plot((x0(1,1:qmax)),G_T(:,:,2),'c')
plot((x0(1,1:qmax)),G_T2(:,:,2)*ones(size(x0(1,1:qmax))),'--r')
