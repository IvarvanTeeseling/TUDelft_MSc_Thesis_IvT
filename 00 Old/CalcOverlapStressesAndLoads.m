function [Shr_a, Pl_a, Ad_1, Ad_2] = CalcOverlapStressesAndLoads(x, F_k, M_k, Q_k, D_1, A_11, l_B, E, t, E_a, G_a, t_a)
%% Description
% Synt_ax
%   >CalcOverlapStressesAndLoads(x, F, D_1, A_11, D_0, l_A, l_B, E, t, E_a, G_a, t_a)
% Input
